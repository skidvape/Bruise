...
local suc, res = pcall(function()
    for _, v in {'/core/installer.lua', '/core/libs/meta.lua', '/games/universal.lua', '/games/arsenal.lua', '/games/fisch.lua', '/loader.lua', '/songs/numb.mp3', '/songs/w4ytoof4r.mp3'} do
